...
const SectionPolicy: FunctionComponent = () => {
...
<p>Effective date: 01/01/2021 </p>
        <b>1. Introduction</b>
    
        <p>Welcome to <i> Churpy Kenya Limited </i><b>(“Company”, “we”, “our”, “us”)</b> operates <a href="https://www.churpy.co">Churpy.co</a> (hereinafter referred to as <b> “Service”</b>). .</p>
        <p>Our Privacy Policy governs your visit to <a href="https://www.churpy.co">Churpy.co</a>, and explains how we collect, safeguard and disclose information that results from your use of our Service.</p>
    ...
    <b>2. Definitions</b> 
  <p> <b>SERVICE</b>means the <a href="https://www.churpy.co">Churpy.co</a> website operated by <b>Churpy Kenya Limited</b>. <br />
    <br />
 ...
 <br />
We may use your Personal Data to contact you with newsletters, marketing or promotional materials and other information that may be of interest to you. You may opt out of receiving any, or all, of these communications from us by following the <i>`unsubscribe link`</i> . 
    </p>

    <b>Usage Data</b>
    <p>We may also collect information that your browser sends whenever you visit our Service or when you access Service by or through a mobile device <b>(“Usage Data”)</b> .
...
When you access Service with a mobile device, this Usage Data may include information such as the type of mobile device you use, your mobile device unique ID, the IP address of your mobile device, your mobile operating system, the type of mobile Internet browser you use, unique device identifiers and other diagnostic data. </p>
   ...
   <b>Location Data</b>
   <p>We may use and store information about your location if you give us permission to do so <b>(“Location Data”)</b> . We use this data to provide features of our Service, to improve and customize our Service. 
...
<p>While using our Service, we may also collect the following information: sex, age, date of birth, place of birth, passport details, citizenship, registration at place of residence and actual address, telephone number (work, mobile), details of documents on education, qualification, professional training, employment agreements, non-disclosure agreements, information on bonuses and compensation, information on marital status, family members, social security (or other taxpayer identification) number, office location and other data. </p>
    <b>5. Use of Data</b>
    <p>Churpy Kenya Limited uses the collected data for various purposes:
<br />
...
- for any other purpose with your consent.  </p><br /> 
...
We will also retain Usage Data for internal analysis purposes. Usage Data is generally retained for a shorter period, except when this data is used to strengthen the security or to improve the functionality of our Service, or we are legally obligated to retain this data for longer time periods. </p>
    ...
    <b>7. Transferring of Data </b>
    <p>Your information, including Personal Data, may be transferred to – and maintained on – computers located outside your state, province, country or other governmental jurisdiction where the data protection laws may differ from those of your jurisdiction.
...
<li>if we believe disclosure is necessary or appropriate to protect the rights, property, or safety of the Company, our customers, or others. </li>
    ...
    <br />
   <p>If you are a resident of the European Union (EU) and European Economic Area (EEA), you have certain data protection rights, covered by GDPR – See more at <a href="https://eur-lex.europa.eu/eli/reg/2016/679/oj">https://eur-lex.europa.eu/eli/reg/2016/679/oj</a>  
...
We also encourage you to review the <a href="https://support.google.com/analytics/answer/6004245">Google's policy</a> for safeguarding your data.</p>
...
<p>CircleCI is provided by Circle Internet Services, Inc.  
...
For more information on what data Circle CI collects for what purpose and how the protection of the data is ensured, please visit <a href="https://circleci.com/privacy/ ">Circle CI Privacy Policy</a> page.</p>
...
The payment processors we work with are: <br /></p>
<b>15. Stripe</b>

<p>Their Privacy Policy can be viewed at: <a href="https://stripe.com/us/privacy.">stripe privacy policy</a>  
</p>
    <b>16. Link to Other Sites </b>
...
<b>17. Changes to This Privacy Policy </b>
